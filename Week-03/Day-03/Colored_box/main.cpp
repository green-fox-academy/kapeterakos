...
void draw()
{
    ...
    int size2 = SCREEN_HEIGHT/4;

    SDL_SetRenderDrawColor(gRenderer, 255 /*R*/, 0x00 /*G*/, 0x00 /*B*/, 0xFF /*A*/);

    SDL_RenderDrawLine(gRenderer, SCREEN_WIDTH/4, SCREEN_HEIGHT/4, size * 3, SCREEN_HEIGHT/4);

    SDL_SetRenderDrawColor(gRenderer, 0 /*R*/,255 /*G*/, 0x00 /*B*/, 0xFF /*A*/);

    SDL_RenderDrawLine(gRenderer, SCREEN_WIDTH/4, size2 *3, size * 3, size2 * 3);

    SDL_SetRenderDrawColor(gRenderer, 0 /*R*/, 0 /*G*/, 255 /*B*/, 0xFF /*A*/);

    SDL_RenderDrawLine(gRenderer, SCREEN_WIDTH/4, SCREEN_HEIGHT/4, SCREEN_WIDTH/4, size2*3);

    SDL_SetRenderDrawColor(gRenderer, 0 /*R*/, 255/*G*/, 255 /*B*/, 0xFF /*A*/);

    SDL_RenderDrawLine(gRenderer, size *3, SCREEN_HEIGHT/4, size*3, size2*3);
